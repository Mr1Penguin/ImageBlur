...
__kernel void BlurRow(read_only image2d_t image, write_only image2d_t output,
	const unsigned int kernel_width, __constant float *filter, uint image_width)
{
...
__kernel void BlurColumn(read_only image2d_t image, write_only image2d_t output, 
	const unsigned int kernel_width, __constant float *filter, 
